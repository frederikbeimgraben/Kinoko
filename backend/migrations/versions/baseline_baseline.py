...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("protection_source", sa.Text(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table("species_colour_change_trigger")
    op.drop_table("species_colour")
    op.drop_table("pipeline_run_find")
    with op.batch_alter_table("photo", schema=None) as batch_op:
        batch_op.drop_index("ix_photo_species_state")

    op.drop_table("photo")
    op.drop_table("species_trait")
    op.drop_table("species_term")
    ...
    op.drop_table("species_colour_range")
    op.drop_table("species_colour_change")
    op.drop_table("pipeline_run_step")
    op.drop_table("pipeline_run_species")
    with op.batch_alter_table("find", schema=None) as batch_op:
        batch_op.drop_index("ix_find_owner_updated")

    op.drop_table("find")
    with op.batch_alter_table("zone", schema=None) as batch_op:
        batch_op.drop_index("ix_zone_owner_updated")
    ...
    with op.batch_alter_table("marker", schema=None) as batch_op:
        batch_op.drop_index("ix_marker_owner_updated")

    op.drop_table("marker")
    with op.batch_alter_table("combination", schema=None) as batch_op:
        batch_op.drop_index("ix_combination_owner_updated")
    ...
    op.drop_table("user")
    with op.batch_alter_table("term", schema=None) as batch_op:
        batch_op.drop_index("ix_term_kind_slug")

    op.drop_table("term")
    with op.batch_alter_table("taxon", schema=None) as batch_op:
        batch_op.drop_index("ix_taxon_rank_slug")
